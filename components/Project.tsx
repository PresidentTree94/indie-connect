...
export default function Project() {
  return (
    <Link href="/project" className="card p-0 hover:border-primary/40 overflow-hidden group">
      ...
      <div className="p-6">
        <div className="flex items-center justify-between text-xs">
          ...
          <span className="uppercase pale py-1 px-2 rounded-xl font-semibold">Status</span>
        </div>
      ...
      <div className="flex justify-between items-center pt-4 px-6 pb-6 border-t border-white/15">
        <div>
