...
export default function Project() {
  return (
    <div className="rounded-xl overflow-hidden bg-card pale hover:border-primary/40 group">
      <div className="relative h-48 overflow-hidden">
        ...
        <div className="absolute top-4 left-4 flex gap-2 text-xs">
          <span className="py-0.5 px-2 bg-black/40 text-emphasis font-semibold rounded-xl backdrop-blur-md">Role</span>
          <span className="py-0.5 px-2 bg-black/40 text-emphasis font-semibold rounded-xl backdrop-blur-md">Role</span>
        </div>
      </div>
      <div className="p-6">
        ...
        <div className="mt-4 flex gap-2 text-xs">
          <span className="px-2 py-1 bg-[rgba(255,255,255,0.1)] rounded-xl">#Tag</span>
          <span className="px-2 py-1 bg-[rgba(255,255,255,0.1)] rounded-xl">#Tag</span>
          <span className="px-2 py-1 bg-[rgba(255,255,255,0.1)] rounded-xl">#Tag</span>
        </div>
      </div>
      <div className="flex justify-between pt-4 px-6 pb-6 border-t border-[rgba(255,255,255,0.15)]">
