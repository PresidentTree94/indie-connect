...
import { faCode, faPaintbrush, faMusic, faPenNib, faBolt } from "@fortawesome/free-solid-svg-icons";
...
export default function Home() {
  return (
    <main>
      <section className="grid grid-cols-2 gap-12 p-8 max-w-7xl m-auto">
        <div className="flex flex-col justify-center gap-8">
          <h1>Build cool stuff <span className="bg-linear-to-r from-primary to-secondary bg-clip-text text-transparent">together.</span></h1>
          ...
          <div className="flex gap-4">
            ...
            <button className="text-base font-medium text-emphasis px-8 py-3 pale rounded-xl hover:bg-white/10">Join the Community</button>
          </div>
      ...
      <section className="px-8 max-w-7xl m-auto">
        <h2>How It Works</h2>
      ...
      <section className="pale py-4 my-12">
        <div className="px-8 max-w-7xl m-auto flex gap-4">
          <button className="flex items-center gap-2 px-6 py-2 hover:text-emphasis hover:bg-white/10 rounded-full"><FontAwesomeIcon icon={faBolt} className="!w-auto !h-4" />All Projects</button>
          <button className="flex items-center gap-2 px-6 py-2 hover:text-emphasis hover:bg-white/10 rounded-full"><FontAwesomeIcon icon={faCode} className="!w-auto !h-4" />Code</button>
          <button className="flex items-center gap-2 px-6 py-2 hover:text-emphasis hover:bg-white/10 rounded-full"><FontAwesomeIcon icon={faPaintbrush} className="!w-auto !h-4" />Art</button>
          <button className="flex items-center gap-2 px-6 py-2 hover:text-emphasis hover:bg-white/10 rounded-full"><FontAwesomeIcon icon={faMusic} className="!w-auto !h-4" />Music</button>
          <button className="flex items-center gap-2 px-6 py-2 hover:text-emphasis hover:bg-white/10 rounded-full"><FontAwesomeIcon icon={faPenNib} className="!w-auto !h-4" />Writing</button>
        </div>
      </section>
      <section className="px-8 max-w-7xl m-auto pb-8">
